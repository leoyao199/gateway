            ...
            <div style={s.cardListBg}> 
              {serviceCard.map((d)=>(
                <div style={s.cardFlex}>
                  <Image src={d.imageSource} alt={d.title}/>
                  <div >
                    <div style={s.title}>{d.title}</div>
                    <div style={s.content}>{d.content}</div>
                  </div>
                </div>
              ))}
            </div>
